...
const ToastInstance = (message: string | ToastProps) => {
  ...
  let update: React.Dispatch<React.SetStateAction<ToastProps>> = () => {};
  ...
  const InternalToast = () => {
    ...
    return <Toast onClosed={destroy} />;
  };

  canUseDocument() && ReactDOM.render(<InternalToast />, container);
